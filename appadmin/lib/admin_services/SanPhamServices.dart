...
class SanPhamService {
  static const String baseUrl = "http://localhost/app_api/SanPham/";
  static Future<List<SanPham>> fetchSanPham() async {
    final response = await http.get(
      Uri.parse("http://localhost/app_api/SanPham/get_sanpham.php"),
    );
  ...
  static Future<List<SanPham>> fetchByDanhMucId(int danhMucId) async {
    final url = Uri.parse(
      'http://localhost/app_api/DanhMuc/get_sanpham_by_danhmuc.php?danhMucId=$danhMucId',
    );
  ...
  static Future<List<SanPham>> fetchByThuongHieuId(int thuongHieuId) async {
    final url = Uri.parse(
      'http://localhost/app_api/SanPham/get_sanpham_by_thuonghieu.php?thuongHieuId=$thuongHieuId',
    );
    final response = await http.get(url);
  ...
  static Future<List<SanPham>> fetchByDanhMucAndThuongHieu(
    ...
    final response = await http.get(
      Uri.parse(
        'http://localhost/app_api/SanPham/get_sanpham_by_danhmuc_thuonghieu.php?danhMucId=$danhMucId&thuongHieuId=$thuongHieuId',
      ),
    );
